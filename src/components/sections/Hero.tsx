        ...
        >
          ...
          <motion.div variants={fadeIn} className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button 
              ...
              className="w-full sm:w-auto px-8 py-4 bg-[#005287] hover:bg-[#005287]/90 text-white rounded font-bold uppercase tracking-widest text-xs transition-all flex items-center justify-center gap-2 group shadow-[0_0_20px_rgba(0,82,135,0.4)]">
              Start Hacking
