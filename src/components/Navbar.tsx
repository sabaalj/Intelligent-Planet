...
export function Navbar() {
  ...
  return (
    <nav className="fixed top-8 left-1/2 -translate-x-1/2 z-50 transition-all duration-300 w-[95%] max-w-6xl">
      <div className={`mx-auto px-6 py-4 flex justify-between items-center rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md shadow-2xl relative transition-colors ${
        ...
        <div className="text-xl md:text-2xl font-bold tracking-tighter flex items-center gap-3 shrink-0">
          ...
          <span className="hidden sm:inline">INTELLIGENT <span className="text-[#005287]">PLANET</span></span>
        ...
        <div className="hidden lg:flex items-center gap-2 text-sm font-medium text-white/80">
          ...
          <button className="ml-4 bg-[#005287] hover:bg-[#005287]/90 text-white px-6 py-2 rounded-full font-bold transition-all text-sm whitespace-nowrap uppercase tracking-wider">
            Register Now
          </button>
        </div>
        ...
        {isMenuOpen && (
          ...
          >
            <div className="bg-black/90 backdrop-blur-xl border border-white/10 rounded-2xl p-6 shadow-2xl space-y-4">
              ...
              <button className="w-full bg-[#005287] hover:bg-[#005287]/90 text-white py-4 rounded-xl font-bold uppercase tracking-widest text-xs transition-all mt-4">
                Register Now
              </button>
            </div>
          </motion.div>
