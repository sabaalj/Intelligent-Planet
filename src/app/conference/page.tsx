        ...
        <motion.div
          ...
          animate={
            isPaused
              ? {}
              : {
                  x: direction === "left" ? [0, -containerWidth] : [0, containerWidth],
                }
          }
          transition={{
            x: {
  ...
  return (
    <main className="relative min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <RegistrationModal
        ...
        onRegistered={(u) => setCurrentUser(u)}
      />
      ...
      <SectionFrame id="journey" title="Event Journey" subtitle="Experience the conference step-by-step">
